...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AmazonCloudSearch2013"
...
function C:uploadDocuments(input, options)
   return self:invokeOperation(schemas.Service, schemas.UploadDocuments, input, options)
end
