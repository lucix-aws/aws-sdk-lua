...
describe("endpoint rules", function()
    it("For region ap-northeast-1 with FIPS disabled and DualStack disabled", function()
        ...
        assert.are.equal("https://mediapackage-vod.ap-northeast-1.amazonaws.com", result.url)
    end)
    ...
    it("For region ap-northeast-2 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.ap-northeast-2.amazonaws.com", result.url)
    end)
    ...
    it("For region ap-south-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.ap-south-1.amazonaws.com", result.url)
    end)
    ...
    it("For region ap-southeast-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.ap-southeast-1.amazonaws.com", result.url)
    end)
    ...
    it("For region ap-southeast-2 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.ap-southeast-2.amazonaws.com", result.url)
    end)
    ...
    it("For region eu-central-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.eu-central-1.amazonaws.com", result.url)
    end)
    ...
    it("For region eu-north-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.eu-north-1.amazonaws.com", result.url)
    end)
    ...
    it("For region eu-west-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.eu-west-1.amazonaws.com", result.url)
    end)
    ...
    it("For region eu-west-2 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.eu-west-2.amazonaws.com", result.url)
    end)
    ...
    it("For region eu-west-3 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.eu-west-3.amazonaws.com", result.url)
    end)
    ...
    it("For region sa-east-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.sa-east-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-east-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-east-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-east-2 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-east-2.amazonaws.com", result.url)
    end)
    ...
    it("For region us-west-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-west-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-west-2 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-west-2.amazonaws.com", result.url)
    end)
    ...
    it("For region us-east-1 with FIPS enabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-east-1.api.aws", result.url)
    end)
    ...
    it("For region us-east-1 with FIPS enabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-east-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-east-1 with FIPS disabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-east-1.api.aws", result.url)
    end)
    ...
    it("For region cn-north-1 with FIPS enabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.cn-north-1.api.amazonwebservices.com.cn", result.url)
    end)
    ...
    it("For region cn-north-1 with FIPS enabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.cn-north-1.amazonaws.com.cn", result.url)
    end)
    ...
    it("For region cn-north-1 with FIPS disabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.cn-north-1.api.amazonwebservices.com.cn", result.url)
    end)
    ...
    it("For region cn-north-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.cn-north-1.amazonaws.com.cn", result.url)
    end)
    ...
    it("For region us-gov-east-1 with FIPS enabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-gov-east-1.api.aws", result.url)
    end)
    ...
    it("For region us-gov-east-1 with FIPS enabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-gov-east-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-gov-east-1 with FIPS disabled and DualStack enabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-gov-east-1.api.aws", result.url)
    end)
    ...
    it("For region us-gov-east-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-gov-east-1.amazonaws.com", result.url)
    end)
    ...
    it("For region us-iso-east-1 with FIPS enabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-iso-east-1.c2s.ic.gov", result.url)
    end)
    ...
    it("For region us-iso-east-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-iso-east-1.c2s.ic.gov", result.url)
    end)
    ...
    it("For region us-isob-east-1 with FIPS enabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod-fips.us-isob-east-1.sc2s.sgov.gov", result.url)
    end)
    ...
    it("For region us-isob-east-1 with FIPS disabled and DualStack disabled", function()
        ...
        local result, err = endpoint.resolve(ruleset, params)
        assert.is_not_nil(result, "expected endpoint but got error: " .. tostring(err))
        assert.are.equal("https://mediapackage-vod.us-isob-east-1.sc2s.sgov.gov", result.url)
    end)
