...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AWSMPDeploymentParametersService"
...
function C:putDeploymentParameter(input, options)
   return self:invokeOperation(schemas.Service, schemas.PutDeploymentParameter, input, options)
end
