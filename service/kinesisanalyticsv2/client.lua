...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "KinesisAnalytics_20180523"
...
function C:addApplicationVpcConfiguration(input, options)
   return self:invokeOperation(schemas.Service, schemas.AddApplicationVpcConfiguration, input, options)
end
...
function C:createApplicationPresignedUrl(input, options)
   return self:invokeOperation(schemas.Service, schemas.CreateApplicationPresignedUrl, input, options)
end

function C:createApplicationSnapshot(input, options)
   return self:invokeOperation(schemas.Service, schemas.CreateApplicationSnapshot, input, options)
end
...
function C:deleteApplicationSnapshot(input, options)
   return self:invokeOperation(schemas.Service, schemas.DeleteApplicationSnapshot, input, options)
end

function C:deleteApplicationVpcConfiguration(input, options)
   return self:invokeOperation(schemas.Service, schemas.DeleteApplicationVpcConfiguration, input, options)
end
...
function C:describeApplicationOperation(input, options)
   return self:invokeOperation(schemas.Service, schemas.DescribeApplicationOperation, input, options)
end

function C:describeApplicationSnapshot(input, options)
   return self:invokeOperation(schemas.Service, schemas.DescribeApplicationSnapshot, input, options)
end

function C:describeApplicationVersion(input, options)
   return self:invokeOperation(schemas.Service, schemas.DescribeApplicationVersion, input, options)
end
...
function C:listApplicationOperations(input, options)
   return self:invokeOperation(schemas.Service, schemas.ListApplicationOperations, input, options)
end
...
function C:listApplicationSnapshots(input, options)
   return self:invokeOperation(schemas.Service, schemas.ListApplicationSnapshots, input, options)
end
...
function C:rollbackApplication(input, options)
   return self:invokeOperation(schemas.Service, schemas.RollbackApplication, input, options)
end
...
function C:updateApplicationMaintenanceConfiguration(input, options)
   return self:invokeOperation(schemas.Service, schemas.UpdateApplicationMaintenanceConfiguration, input, options)
end
