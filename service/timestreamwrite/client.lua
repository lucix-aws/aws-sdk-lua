...
function C:createBatchLoadTask(input, options)
...
function C:describeBatchLoadTask(input, options)
   return self:invokeOperation(schemas.Service, schemas.DescribeBatchLoadTask, input, options)
end

function C:describeDatabase(input, options)
...
function C:listBatchLoadTasks(input, options)
...
function C:resumeBatchLoadTask(input, options)
...
function C:writeRecords(input, options)
