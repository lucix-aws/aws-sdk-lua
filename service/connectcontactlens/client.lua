...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AmazonConnectContactLens"
...
function C:listRealtimeContactAnalysisSegments(input, options)
   return self:invokeOperation(schemas.Service, schemas.ListRealtimeContactAnalysisSegments, input, options)
end
