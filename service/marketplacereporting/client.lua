...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AWSMarketplaceReporting"
...
function C:getBuyerDashboard(input, options)
   return self:invokeOperation(schemas.Service, schemas.GetBuyerDashboard, input, options)
end
