...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AWSMPEntitlementService"
...
function C:getEntitlements(input, options)
   return self:invokeOperation(schemas.Service, schemas.GetEntitlements, input, options)
end
