...
function M.new(cfg)
   local c = cfg or {}
   c.service_id = "AmazonSageMakerFeatureStoreRuntime"
...
function C:batchGetRecord(input, options)
   return self:invokeOperation(schemas.Service, schemas.BatchGetRecord, input, options)
end

function C:deleteRecord(input, options)
   return self:invokeOperation(schemas.Service, schemas.DeleteRecord, input, options)
end

function C:getRecord(input, options)
   return self:invokeOperation(schemas.Service, schemas.GetRecord, input, options)
end
